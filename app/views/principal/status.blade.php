...
<html>
    <head>
        ...
        <title>Status del Usuario</title>
    ...
    <body>
        ...
        <div id="contenedor">
            <span class="titulo fondo-titulo-principal">Status del Usuario</span>
            <div style="margin: 0 auto; text-align: center">
                <p>
                    Lo sentimos su cuenta esta inactiva, por favor comuniquese por medio de los tel&eacute;fonos<br>
                    <code>
                        (0414) 6815287
                    </code>
                </p>
